...
description: "comfyui-mcp is a full Claude Code plugin: 37 AI skills, 11 slash commands, 4 autonomous agents, and 3 hooks on top of the 37 MCP tools — expert ComfyUI knowledge that grows with every release."
icon: "puzzle-piece"
---
