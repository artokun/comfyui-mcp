...
| المنفذ | الغرض |
|---|---|
| `bridge` (9199) | جسر الواجهة بين اللوحة ⇄ المنسّق (اتصال سطح المكتب نفسه). |
| `bridge − 1` (9198) | سطح `panel_*` عبر HTTP-MCP — **ليس** هذا البروتوكول. |
| **`bridge − 2` (9197)** | **مستمع الاقتران / التحكّم عن بُعد الذي تتصل به.** مقيَّد برمز، مربوط على `0.0.0.0` (قابل للوصول على الشبكة المحلية). |
