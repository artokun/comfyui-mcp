...
<ParamField path="id" type="string">
  Setting id, e.g. 'Comfy.Validation.Workflows'. Omit to list all stored settings.
</ParamField>
<ParamField path="filter" type="string">
  Case-insensitive substring filter on setting ids when listing (e.g. 'preview'). Ignored when `id` is given.
</ParamField>
...
<ParamField path="id" type="string" required>
  Setting id, e.g. 'Comfy.Validation.Workflows'.
</ParamField>
<ParamField path="value" type="string | number | boolean | object | any[]" required>
  New value. Stored as-is; booleans/numbers are NOT coerced from strings (pass true, not "true").
</ParamField>
